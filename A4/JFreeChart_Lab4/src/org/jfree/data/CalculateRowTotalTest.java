...
public class CalculateRowTotalTest {
	...
	private DefaultKeyedValues2D allNull;
	...
	public void setUp() throws Exception {
		...
		this.allNull = new DefaultKeyedValues2D();
		this.allNull.addValue(null, 0, 0);
		this.allNull.addValue(null, 0, 1);
		this.allNull.addValue(null, 0, 2);
	}
	...
	public void testCalculateRowTotalWithDataNull() {
	    Values2D data = null;
	    DataUtilities.calculateRowTotal(data, 0); // This should throw an IllegalArgumentException due to the null check.
	}
	
//	@Test(expected = illegalArgumentException)
//	public void testCalculateRowTotalWithDataNull() {
//	    DataUtilities.calculateRowTotal(allNull, 0); // This should throw a NullPointerException due to the null check.
//	}
